...
for(var a=0,o=t.length;a<o;a+=1)"undefined"==typeof n[t[a]]&&(n[t[a]]={}),n=n[t[a]];return n},
...
// Throw all errors
_.has(t,"error")||a.fail(function(e,t,n){_.defer(function(){throw n})}),
...
!1 in document.createElement("input")&&EE.insert_placeholders(),EE.cp.cleanUrls(),EE.cp.bindCpMessageClose(),EE.cp.channelMenuFilter(),EE.cp.bindSortableFolderLists(),EE.cp.addLastToChecklists(),EE.cp.bindPostLinks()}),/**
 ...
 */
EE.cp.bindPostLinks=function(){e("body").on("click","a[data-post-url]",function(t){t.preventDefault();var n=e("<form/>",{action:e(this).data("postUrl"),method:"post"});n.append(e("<input/>",{name:"csrf_token",value:EE.CSRF_TOKEN})),n.appendTo("body").submit()})},/**
...
var t=/[&?](S=[A-Za-z0-9]+)/;EE.cp.setBasePath=function(n,a){var n=n.replace(/&amp;/g,"&"),o=n.match(t)||["",""],i=EE.BASE.match(t)||["",""],s=function(e,t){if(t)return t.replace(i[1],o[1])};e("a").attr("href",s),e("form").attr("action",s),
...
e.getJSON(EE.BASE+"&C=login&M=refresh_csrf_token",function(e){EE.cp.setBasePath(e.base)})};var n=/(.*?)[?](.*?&)?(D=cp(?:&C=[^&]+(?:&M=[^&]+)?)?)(?:&(.+))?$/,a=/&?[DCM]=/g,o=/^&+/,i=/&+$/,s=/(^|&)S=0(&|$)/;EE.cp.cleanUrl=function(e,t){t=t||e,// i exists if coming from jQuery attr callback
t=t||"",
// Move session to the end
t=t.toString().replace(/^(\S*?)S=(\S+?)&(\S*?)$/g,"$1$3&S=$2");var r=n.exec(t);if(r){
// result[1] // index.php
// result[2] // S=49204&
