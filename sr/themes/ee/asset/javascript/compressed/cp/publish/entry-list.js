...
$("body").on("click","form > .filters .sub-menu a, .filters .filter-clear a, .paginate ul li a",function(e){$.ajax({url:$(this).attr("href"),type:"GET",dataType:"json",success:t}),e.preventDefault()})});